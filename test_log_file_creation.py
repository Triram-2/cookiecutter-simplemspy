...
try:
    print("--- [Test Script] Attempting to import get_logger from src.core.logging_config ---")
    ...
    print(f"--- [Test Script] Logging standard library message for logger '{log_name}' ---")
    std_test_logger.info("This is a standard library INFO message for test_file_log, to be intercepted.")
